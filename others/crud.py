...
def get_product(db: Session, id: int):
    return (
        db.query(models.Product.ProductID,models.Product.ProductName,models.Product.Discontinued,models.Category.CategoryName,models.Product.CategoryID).filter(models.Category.CategoryID == models.Product.CategoryID, models.Product.SupplierID == id).order_by(models.Product.ProductID.desc()).all()
    )
...
def update_supplier(db: Session,supp:schemas.Supplier3,id:int):
    ...
    if data is not None or bool(data)==True:
